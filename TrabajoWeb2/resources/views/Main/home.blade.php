            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4 mb-4">
                    <div class="card bg-dark text-white shadow text-center">
                        ...
                        <div class="card-body ">
                            <h5 class="card-title">Lista Proyectos</h5>
                            <p class="card-text"></p>
                            <a href="{{route('Proyectos.subirProyecto')}}" class="btn btn-success d-grid text-white mb-3">Ingresar una propuesta</a>
                            <a href="{{route('Proyectos.proyectos')}}" class="btn btn-primary d-grid text-white">Revisar propuestas</a>
                ...
                <div class="col-12 col-lg-4 mb-4">
                    <div class="card bg-dark text-white shadow text-center">
                        ...
                        <div class="card-body ">
                            ...
                            <p class="card-text"></p>
                            <a href="{{route('Alumnos.alumnos')}}" class="btn btn-success d-grid text-white mb-3">Agregar un alumno</a>
                            <a href="{{route('Alumnos.alumnos')}}" class="btn btn-primary d-grid text-white">Revisar alumnos inscritos</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4 mb-4">
                    <div class="card bg-dark text-white shadow text-center">
                        ...
                        <div class="card-body ">
                            ...
                            <p class="card-text"></p>
                            <a href="{{route('Profesores.agregarProfesor')}}" class="btn btn-success d-grid text-white mb-3">Agregar un profesor</a>
                            <a href="{{route('Profesores.profesores')}}" class="btn btn-primary d-grid text-white">Revisar equipo de profesores</a>
                        </div>
                    </div>
                </div>
